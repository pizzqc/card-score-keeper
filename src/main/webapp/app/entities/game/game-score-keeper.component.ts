...
@Component({
    selector: 'jhi-game-score-keeper',
    templateUrl: './game-score-keeper.component.html'
})
export class GameScoreKeeperComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: GameScoreKeeper) {
        return item.id;
    }
